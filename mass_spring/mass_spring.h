...
public:
    ...
    {
        auto valmat = MatrixView<double, ColMajor>(Masses().size(), D, D, values.Data());
        auto dvalmat = MatrixView<double, ColMajor>(Masses().size(), D, D, dvalues.Data());
        auto ddvalmat = MatrixView<double, ColMajor>(Masses().size(), D, D, ddvalues.Data());
...
public:
    ...
    virtual void Evaluate (VectorView<double> x, VectorView<double> f) const
    {
        ...
        auto xmat = MatrixView<double, ColMajor>(mss.Masses().size(), D, D, x.Data());
        auto fmat = MatrixView<double, ColMajor>(mss.Masses().size(), D, D, f.Data());
